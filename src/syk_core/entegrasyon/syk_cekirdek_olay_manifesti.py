...
class SYKCekirdekOlayManifesti:
    SURUM = "1.0"

    KAYNAKLAR = (
        "src/syk_core/entegrasyon/cekirdek_durum_makinesi.py",
        "src/syk_core/entegrasyon/cekirdek_orchestrator.py",
        "src/syk_core/entegrasyon/core_olay_koprusu.py",
        "src/syk_core/entegrasyon/tek_olay_akis.py",
        "src/syk_core/entegrasyon/tek_olay_core_motoru.py",
        "src/syk_core/entegrasyon/uc_uca_core_dogrulama.py",
    )

    TESTLER = (
        "tests/test_cekirdek_durum_makinesi.py",
        "tests/test_cekirdek_orchestrator.py",
        "tests/test_core_olay_koprusu.py",
        "tests/test_tek_olay_akis.py",
        "tests/test_tek_olay_core_motoru.py",
        "tests/test_uc_uca_core_dogrulama.py",
    )
        ...
        for goreli in self.tum_dosyalar:
            ...
            if not tam_yol.is_file():
                raise FileNotFoundError(
                    f"Cekirdek olay dosyasi bulunamadi: {goreli}"
                )
