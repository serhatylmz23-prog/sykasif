...
class SYKCekirdekKanitBirlestirmeManifesti:
    SURUM = "1.0"

    KAYNAKLAR = (
        "src/syk_core/entegrasyon/cekirdek_kanit_zinciri_birlestirme.py",
        "src/syk_core/entegrasyon/cekirdek_kanit_zinciri_sonuc_raporu.py",
        "src/syk_core/entegrasyon/kanit_guven_konsensus.py",
        "src/syk_core/entegrasyon/agirlikli_uzman_motoru.py",
        "src/syk_core/entegrasyon/uzman_sonuc_agi.py",
    )

    TESTLER = (
        "tests/test_cekirdek_kanit_zinciri_birlestirme.py",
        "tests/test_cekirdek_kanit_zinciri_sonuc_raporu.py",
        "tests/test_kanit_guven_konsensus.py",
        "tests/test_agirlikli_uzman_motoru.py",
        "tests/test_uzman_sonuc_agi.py",
    )
        ...
        for goreli in self.tum_dosyalar:
            ...
            if not tam_yol.is_file():
                raise FileNotFoundError(
                    f"Cekirdek kanit dosyasi bulunamadi: {goreli}"
                )
