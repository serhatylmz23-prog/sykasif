...
class SYKKanitLaboratuvarManifesti:
    SURUM = "1.0"

    KAYNAKLAR = (
        "src/syk_core/kanit/guven_motoru.py",
        "src/syk_core/kanit/kanit_arsiv_modeli.py",
        "src/syk_core/kanit/kaynak_modeli.py",
        "src/syk_core/kanit/kaynak_tarama_modeli.py",
        "src/syk_core/kanit/kaynak_turleri.py",
        "src/syk_core/laboratuvar/materyal_derin_analiz.py",
        "src/syk_core/laboratuvar/materyal_modeli.py",
    )

    TESTLER = (
        "tests/test_guven_motoru.py",
        "tests/test_kanit_arsiv_modeli.py",
        "tests/test_kaynak_modeli.py",
        "tests/test_kaynak_tarama_modeli.py",
        "tests/test_kaynak_turleri.py",
        "tests/test_materyal_derin_analiz.py",
        "tests/test_materyal_modeli.py",
    )
        ...
        for goreli in self.tum_dosyalar:
            ...
            if not tam_yol.is_file():
                raise FileNotFoundError(
                    f"Kanit/laboratuvar dosyasi bulunamadi: {goreli}"
                )
